...
var _Root = _interopRequireWildcard(require("./components/root/Root"));
...
function App() {
  ...
  var addContact = function addContact(name, phone, email) {
    setContacts([].concat(_toConsumableArray(contacts), [{
      name: name,
      phone: phone,
      email: email
    }]));
  };
  var addAppointment = function addAppointment(name, contact, date, time) {
    setAppointments([].concat(_toConsumableArray(appointments), [{
      name: name,
      contact: contact,
      date: date,
      time: time
...
},{"./components/root/Root":17,"./containers/appointmentsPage/AppointmentsPage":20,"./containers/contactsPage/ContactsPage":21,"react":undefined,"react-router-dom":6,"react/jsx-runtime":14}],16:[function(require,module,exports){
"use strict";
...
},{"react":undefined,"react-router-dom":6,"react/jsx-runtime":14}],18:[function(require,module,exports){
"use strict";
...
},{"react":undefined,"react/jsx-runtime":14}],19:[function(require,module,exports){
"use strict";
...
var _react = _interopRequireDefault(require("react"));
var _Tile = require("../../components/tile/Tile");
var _jsxRuntime = require("react/jsx-runtime");
var _excluded = ["name"];
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }
...
var TileList = function TileList(_ref) {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
    children: items.map(function (item, index) {
      var name = item.name,
        description = _objectWithoutProperties(item, _excluded);
      return /*#__PURE__*/(0, _jsxRuntime.jsx)(_Tile.Tile, {
        name: name,
...
},{"../../components/tile/Tile":18,"react":undefined,"react/jsx-runtime":14}],20:[function(require,module,exports){
"use strict";
...
},{"react":undefined,"react/jsx-runtime":14}],21:[function(require,module,exports){
"use strict";
...
function _iterableToArrayLimit(arr, i) { var _i = arr == null ? null : typeof Symbol !== "undefined" && arr[Symbol.iterator] || arr["@@iterator"]; if (_i == null) return; var _arr = []; var _n = true; var _d = false; var _s, _e; try { for (_i = _i.call(arr); !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"] != null) _i["return"](); } finally { if (_d) throw _e; } } return _arr; }
function _arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }
var ContactsPage = function ContactsPage(_ref) {
  ...
  var _useState7 = (0, _react.useState)(false),
    ...
    isDuplicate = _useState8[0],
    setIsDuplicate = _useState8[1];
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
    children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)("section", {
      ...
      }), /*#__PURE__*/(0, _jsxRuntime.jsx)(_ContactForm.ContactForm, {
        name: name,
        setName: setName,
        phone: phone,
        setPhone: setPhone,
      ...
      }), isDuplicate && /*#__PURE__*/(0, _jsxRuntime.jsx)("p", {
        style: {
          color: "red"
        },
      ...
      children: [/*#__PURE__*/(0, _jsxRuntime.jsx)("h2", {
        children: "Contacts"
      }), /*#__PURE__*/(0, _jsxRuntime.jsx)(_TileList.TileList, {
        items: contacts
      })]
    })]
  });
...
},{"../../components/contactForm/ContactForm":16,"../../components/tileList/TileList":19,"react":undefined,"react/jsx-runtime":14}],22:[function(require,module,exports){
"use strict";
